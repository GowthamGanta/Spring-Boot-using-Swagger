...
public class ParticipantValidationImplTest {
	...
	@Test
	public void testValidateDeleteParticipantRequest() {

		DeleteParticipantRequest request = new DeleteParticipantRequest();
		request.setParticipantId(2);
		request.setGroupId(1);

		Set<String> participant = participantValidationImpl.validateDeleteParticipantRequest(request);
	...
	@Test
	public void testValidateDeleteParticipantRequestFailure() {
