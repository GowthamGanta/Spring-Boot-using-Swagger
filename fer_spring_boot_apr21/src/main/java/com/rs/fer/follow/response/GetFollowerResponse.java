...
public class GetFollowerResponse extends AbstractResponse {

	public GetFollowerResponse(HttpStatus status, String statusCode, String message, Set<String> errorMessages) {
